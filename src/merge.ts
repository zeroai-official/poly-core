...
import type { HexAddress, MergePositionsParams } from "./types.js";
...
/**
 * Builds a SafeTransaction for CTF mergePositions.
 * Note: amount is a raw uint256 (usually collateral amount in token base units).
 */
export function createMergePositionsTx(params: MergePositionsParams): SafeTransaction {
